          ...
          <div class="col-md-12 col-sm-12">
            ...
            <div class="row">
              <div class="col-md-2 col-sm-2" style="margin-bottom: 5px">
                <a href="<?= base_url('Borrowing/AddBorrowingEquipment') ?>">
                  <button class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add Borrowing Equipment</button>
                </a>
              </div>
            </div>
            <div class="ibox">
                      ...
                      ?>
                        <tr>
                          ...
                          <td style="text-align: center; vertical-align: middle">
                            <a href="<?= base_url('Borrowing/EditBorrowingEquipment/' . substr(sha1($d->idPinjamAlat), 6, 4)) ?>"><button class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></button></a>
                          </td>
                        </tr>
                      <?php
                      }
