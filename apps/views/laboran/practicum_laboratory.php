          ...
          <div class="col-md-12 col-sm-12">
            ...
            <div class="row">
              <div class="col-md-2 col-sm-2" style="margin-bottom: 5px">
                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tambahLab"><i class="fa fa-plus"></i> Add Practicum Laboratory</button>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="row">
                                          <div class="col-md-2 col-sm-6">
                                            <div class="i-checks">
                                              <label>
                                                <input type="radio" name="lokasi_lab" id="lokasi_lab" value="Lantai 1" <?php if ($d->lokasiLab == 'Lantai 1') echo 'checked'; ?>> <i></i> Lantai 1
                                              </label>
                                            </div>
                                          </div>
                                          <div class="col-md-2 col-sm-6">
                                            <div class="i-checks">
                                              <label>
                                                <input type="radio" name="lokasi_lab" id="lokasi_lab" value="Lantai 2" <?php if ($d->lokasiLab == 'Lantai 2') echo 'checked'; ?>> <i></i> Lantai 2
                                              </label>
                                            </div>
                                          </div>
                                          <div class="col-md-2 col-sm-6">
                                            <div class="i-checks">
                                              <label>
                                                <input type="radio" name="lokasi_lab" id="lokasi_lab" value="Lantai 3" <?php if ($d->lokasiLab == 'Lantai 3') echo 'checked'; ?>> <i></i> Lantai 3
                                              </label>
                                            </div>
                                          </div>
                                          <div class="col-md-2 col-sm-6">
                                            <div class="i-checks">
                                              <label>
                                                <input type="radio" name="lokasi_lab" id="lokasi_lab" value="Lantai 4" <?php if ($d->lokasiLab == 'Lantai 4') echo 'checked'; ?>> <i></i> Lantai 4
                                              </label>
                                            </div>
                                          </div>
                                        </div>
