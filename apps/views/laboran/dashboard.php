                          ...
                          <div class="row">
                            <div class="col-md-6 col-sm-12">
                              <div class="form-group">
                                ...
                                <textarea name="isi_pengumuman" id="isi_pengumuman" class="form-control" rows="3" required></textarea>
                              </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                              <div class="form-group">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="row">
                                <div class="col-md-6 col-sm-12">
                                  <div class="form-group">
                                    <label class="font-bold">Content of Announcement</label>
                                    <textarea name="isi_pengumuman" id="isi_pengumuman" class="form-control" rows="3" required><?= $p->isiPengumuman ?></textarea>
                                  </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                  <div class="form-group">
