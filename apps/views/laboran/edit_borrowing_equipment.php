      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-12">
          <h2 style="text-align: center">Edit Borrowing Equipment<br>School of Applied Science School's Laboratory</h2>
        </div>
      </div>
          ...
          <div class="col-md-12 col-sm-12">
            <div class="ibox">
              <div class="ibox-content">
                <form method="post" action="<?= base_url('Borrowing/EditBorrowingEquipment/' . uri('3')) ?>">
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-6 col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="alat_peminjam" id="alat_peminjam" class="form-control alat">
                          ...
                          <?php
                          foreach ($alat as $a) {
                            if ($a->idAlat == $detail->idAlat) {
                              echo '<option value="' . $a->idAlat . '" selected>' . $a->namaAlat . '</option>';
                            } else {
                    ...
                    <div class="col-md-2 col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="jumlah_pinjam" id="jumlah_pinjam" placeholder="Input Qty" class="form-control" value="<?= $detail->jumlah ?>" onkeypress="return hanya_angka(event)" required>
                      </div>
                    </div>
